...
<!--                    <!--<h1>Hello, world ;)  Welcome to best of PersonalSite</h1>-->
<!--                    <div class="carousel" style="margin-left: auto;margin-right: auto; max-width: 100%;" data-role="carousel">-->
<!--                        <div class="slide">-->
<!--                            <img src="images/slider1.jpg" alt="" class="responsive"/>-->
<!--                        </div>-->
<!--                        <div class="slide">-->
<!--                            <img src="images/slider.jpg" alt="" class="responsive"/>-->
<!--                        </div>-->
...
<!--                    </p>-->
<!--                    <p>-->
<!--                        <button class="button large success" role="button" style="color:#FFFFFF;">Learn more</button>-->
<!--                    </p>-->
<!--                </div>-->
                <div class="row about">
