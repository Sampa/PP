...
<div class="post-view">
					...
					<div class="blog_list pull-left">
						<ul class="list-unstyled">
							<li>
								...
								<span><?=date('H:i  j/m-Y   ',$model->create_time); ?></span>
								<?php
									if($model->update_time !== $model->create_time)
										echo date(' H:i j/m-Y  ',$model->update_time);
								?>
							</li>
							<li>
								<a href="#comments-10">
	...
	<div id="comments" class="col-xs-offset-1 col-xs-11 col-sm-6 col-md-4">
		<button type="button" class="close" id="closeComments" aria-hidden="true">×</button>

		<!--- Sofies kommentarer börjar-->
		<div class="container12345" style=" id="kommentarer">
			<div class="row">
				<div class="panel panel-info widget">
					<div class="panel-heading">
						<span class="glyphicon glyphicon-comment"></span>
						<h3 class="panel-title">Coments</h3>
